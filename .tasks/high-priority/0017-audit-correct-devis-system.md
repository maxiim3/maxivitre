...
- **Contrôles** :
  - Cohérence complète avec `.rules/pricing.md`
  - Respect stratégie `.rules/business-model.md`
  - Application correcte `.rules/devis-business-rules.md`
...
### Tarification de Base (selon .rules/pricing.md)
- **Prix de base** : 2€/m² + 8€ frais fixes
- **Zones** : +0€ (Zone 1), +10€ (Zone 2), +15€ (Zone 3)
- **Minimums** : 50€ particuliers, 80€ professionnels

### Offres Commerciales (selon .rules/pricing.md)
- **Offre Découverte** : -25% première intervention (tous clients)
- **Fidélité Pro** : -20% si intervention < 2 mois
- **Fidélité Particulier** : -15% si intervention < 6 mois

### Focus Métier (selon .rules/business-model.md)
- **Priorité commerces** : 70% focus, spécialisation extérieur
- **Horaires flexibles** : Weekend, pas de perturbation activité
- **Positionnement premium** : Qualité, transparence tarifaire
