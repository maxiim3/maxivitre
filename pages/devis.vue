  ...
  <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Window Cleaning Estimator</h1>
        <button
      ...
      <div v-if="selectedWindows.length === 0" class="text-center py-12">
        <h3 class="mt-2 text-sm font-semibold text-gray-900">No windows added</h3>
        <p class="mt-1 text-sm text-gray-500">Get started by adding a window to estimate.</p>
        <div class="mt-6">
          <button
            @click="isDrawerOpen = true"
...
const grandTotal = computed(() => {
  return selectedWindows.value.reduce((total, window) => {
